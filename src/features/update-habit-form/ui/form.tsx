    ...
    <form onSubmit={handleFormSubmit} onChange={handleFormChange} className="w-full grid grid-cols-5 gap-2 items-center">
      <form.Field name="title" validators={{ onChange: z.string().min( 3, 'Must be at least 3 characters long' ) }} children={field =>
        <Field className="col-span-3 line-clamp-1 relative">
          <Input type="text" name={field.name} value={field.state.value} onChange={e => field.handleChange( e.target.value )} className="w-full py-3 outline-none" />
      ...
      <form.Field name="days" children={field =>
        <Fieldset className="grid grid-cols-7 col-span-2">
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Mo</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Tu</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">We</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Th</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Fr</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Sa</Label>
          </Field>
          <Field>
            ...
            <Label className="py-3 flex items-center justify-center cursor-pointer text-zinc-300 peer-checked:text-black peer-focus-visible:outline-2 peer-focus-visible:outline-black">Su</Label>
          </Field>
        </Fieldset>
      }
      />
